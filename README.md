...
## 🎮 [플레이방법]
  ...
  <br>
  게임 시작을 누를 시 3가지 길의 선택지가 생성됩니다.<br>
  맵은 레벨업, 힐, 전투로 구성되어 있으며, 원하는 선택지를 고르시면 됩니다.<br>
  던전에 입장하게 되면 wave마다 몬스터가 생성되고 총 3wave가 존재합니다.<br>
  몬스터를 잡아서 레벨업하여 스킬을 획득하여 최후의 있는 보스를 잡고 게임을 클리어해보세요!<br>
